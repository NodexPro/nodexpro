...
export const WORK_ENGINE_RECURRING_DOCUMENT_SCHEDULER_STATUS = 'scheduler_pending' as const;

export async function runWorkEngineRecurringDocumentScheduler(): Promise<{ status: typeof WORK_ENGINE_RECURRING_DOCUMENT_SCHEDULER_STATUS }> {
