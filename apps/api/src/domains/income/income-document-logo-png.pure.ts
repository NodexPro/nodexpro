...
export type PngDecodeSuccess = {
  ok: true;
  image: DecodedPngRgba;
};

export type PngDecodeResult = PngDecodeSuccess | PngDecodeFailure;
...
export function decodePngToRgbaDetailed(buffer: Buffer): PngDecodeResult {
