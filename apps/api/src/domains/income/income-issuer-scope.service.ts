...
import type { IncomeIssuerContextSummary, IncomeWorkspaceContextAggregate } from './income.types.js';
...
export function activeIncomeIssuerScopeFromContextAggregate(
  contextAgg: IncomeWorkspaceContextAggregate,
