    ...
    actions: [
      {
        ...
        enabled: true,
        note:
          'country_code: IL, US, … (must exist in countries). category must be exactly: VAT | Income Tax | National Insurance | Credit Points | Pricing | Reports | Calendar | Modules. value_type: number | percentage | boolean | string | json | money | date.',
        payload: {
          country_code: 'ISO 3166-1 alpha-2',
          value_key: 'string',
          label: 'string',
          category:
            'VAT|Income Tax|National Insurance|Credit Points|Pricing|Reports|Calendar|Modules (exact label)',
          module_scope: 'string',
