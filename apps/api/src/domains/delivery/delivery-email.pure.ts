...
import type { DeliveryEmailEnvelope } from './delivery-email.types.js';

export function validateDeliveryEmailEnvelope(envelope: DeliveryEmailEnvelope): void {
...
export function normalizeDeliveryEmailFailureReason(error: unknown): string {
