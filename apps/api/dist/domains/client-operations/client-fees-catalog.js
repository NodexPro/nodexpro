export const BUILT_IN_FEE_SERVICES = [
...
export const CHARGING_TYPE_LABELS = {
    monthly: 'חודשי',
    bi_monthly: 'דו חודשי',
    quarterly: 'רבעוני',
    yearly: 'שנתי',
...
export const BILLING_DAY_RANGE_LABELS = {
    '1_5': '1–5',
    '6_9': '6–9',
    '10_14': '10–14',
    '15_20': '15–20',
...
export const BILLING_DAY_RANGE_ORDER = ['1_5', '6_9', '10_14', '15_20', '21_31'];
export function isAllowedBillingDayRange(v) {
...
export const DEFAULT_END_ACTION_LABELS = {
