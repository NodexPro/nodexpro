...
export function formatNationalInsuranceRegistryDisplayHe(national_insurance_type, national_insurance_monthly_amount) {
    ...
    if (national_insurance_type === 'not_applicable')
