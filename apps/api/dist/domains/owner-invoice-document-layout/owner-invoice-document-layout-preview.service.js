...
import { DEFAULT_DISPLAY_OPTIONS, resolveBrandingProfile, } from '../income/income-document-branding.pure.js';
import { adaptOwnerLayoutDefinitionForCanonicalRenderer } from './owner-invoice-document-layout-resolver.pure.js';
function sampleBrandingForOwnerPreview(definition, overrides) {
...
export function buildOwnerInvoiceLayoutPreviewHtml(definition, overrides) {
