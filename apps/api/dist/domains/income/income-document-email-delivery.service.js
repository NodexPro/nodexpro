...
async function loadIssuedDocumentForEmail(orgId, incomeDocumentId) {
...
export async function executeSendIncomeDocumentByEmail(ctx, body, deps = defaultDeps) {
    ...
    const deliveryIdempotencyKey = buildIncomeDocumentEmailDeliveryIdempotencyKey(incomeDocumentId, commandIdempotencyKey);
