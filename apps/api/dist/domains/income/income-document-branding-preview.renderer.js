  ...
  `;
    const metaRows = [
        ...
        params.allocation_number_visible
            ? metaRow('מספר הקצאה', params.allocation_number_display?.trim() || '—', docPreviewIcon('id'))
            : '',
    ]
        .filter(Boolean)
        .join('');
...
.nx-doc__issuer-line-icon { display: inline-flex; flex-shrink: 0; color: var(--nx-doc-icon); width: 14px; height: 14px; }
