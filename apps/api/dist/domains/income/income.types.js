...
export const INCOME_COMMAND_CREATE_CUSTOMER_FOR_ISSUER = 'create_income_customer_for_issuer';
export const INCOME_COMMAND_UPDATE_CUSTOMER_FOR_ISSUER = 'update_income_customer_for_issuer';
...
export const INCOME_COMMAND_SEND_DOCUMENT_BY_DOCFLOW = 'send_income_document_by_docflow';
...
export const INCOME_COMMAND_UPDATE_ALLOCATION_NUMBER = 'update_income_document_allocation_number';
...
export const INCOME_DOCUMENT_DOCFLOW_SEND_AGGREGATE_KEY = 'income_document_docflow_send_aggregate';
...
export const INCOME_ISSUED_DOCUMENT_VIEW_AGGREGATE_KEY = 'income_issued_document_view_aggregate';
