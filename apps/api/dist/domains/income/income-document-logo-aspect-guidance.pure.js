 ...
 */
import { SECTIONED_LOGO_FRAME, SECTIONED_LOGO_RECOMMENDED_UPLOAD, } from './income-document-sectioned-logo-frame.pure.js';
...
function readPngDimensions(buffer) {
    if (buffer.length < 24)
        return null;
    if (buffer.compare(PNG_SIG, 0, 8, 0, 8) !== 0)
        return null;
...
export function probeLogoImageDimensions(mime, buffer) {
...
export function formatLogoAspectRatioLabel(aspect) {
...
export function buildWideLogoAspectRatioWarning(aspect) {
    return [
...
export function assessLogoAspectForWideFrame(dataUrl) {
    const empty = {
        width_px: null,
        height_px: null,
        aspect_ratio: null,
