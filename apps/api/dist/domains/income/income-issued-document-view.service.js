...
import { assertRowMatchesIssuerScope, optionalUuid, reqUuid, } from './income.guards.js';
...
import { buildIncomeIssuedDocumentPdfAction, } from './income-document-view-action.pure.js';
...
export async function buildIncomeIssuedDocumentViewAggregate(params) {
    ...
    const allocationPolicy = await resolveIncomeTaxAllocationNumberPolicyForOrg(scope.org_id, 'IL', doc.issue_date);
 ...
 */
export async function updateIssuedIncomeDocumentAllocationNumber(ctx, body) {
...
export function isIssuedAllocationNumberCommandBody(body) {
