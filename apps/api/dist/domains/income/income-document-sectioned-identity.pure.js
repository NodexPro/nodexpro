 ...
 */
export const SECTIONED_NUMBER_BAR_WIDTH_BY_DOC_TYPE = {
    tax_invoice: '152px',
    quote: '138px',
    deal_invoice: '148px',
    receipt: '78px',
...
function widthForDocumentType(documentType) {
...
export function resolveSectionedDocumentIdentityPresentation(params) {
    ...
    if (!documentType && params.doc_type_label?.trim()) {
        ...
        const entry = Object.entries(DOCUMENT_TYPE_LABELS_HE).find(([, he]) => he === label);
