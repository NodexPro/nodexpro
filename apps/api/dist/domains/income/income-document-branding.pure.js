...
export const INCOME_DOCUMENT_STYLE_PRESETS = [
    {
        key: 'classic_blue',
        label: 'כחול קלאסי',
...
export function resolveDocumentStyleKeyForRow(row) {
    ...
    return matchDocumentStyleKeyFromLegacyColors(row.primary_color, row.table_header_color, row.totals_color);
}
...
export function applyDocumentStyleToColorColumns(style) {
    return {
