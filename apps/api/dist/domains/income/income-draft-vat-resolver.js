...
import { IL_DRAFT_VAT_FALLBACK_RATE, incomeDraftVatFallbackResolution, } from './income-draft-vat-fallback.pure.js';
export { IL_DRAFT_VAT_FALLBACK_RATE, incomeDraftVatFallbackResolution };
...
function parseRateFromLegalPayload(payload) {
    if (payload == null)
        return null;
...
export async function resolveIncomeDraftVatForOrg(orgId, countryCode, documentDate) {
