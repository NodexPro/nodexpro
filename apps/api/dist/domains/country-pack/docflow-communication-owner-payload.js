...
export function isDocflowCommunicationOwnerPayload(raw) {
    if (!raw || typeof raw !== 'object' || Array.isArray(raw))
        return false;
    return raw.type === DOCFLOW_COMMUNICATION_TYPE;
}
/**
 ...
 */
export function assertValidDocflowCommunicationOwnerPayload(raw) {
    if (!raw || typeof raw !== 'object' || Array.isArray(raw)) {
    ...
    if (!messageTemplate)
        throw badRequest('message_template is required');
    ...
    if (o.target_filter !== undefined && o.target_filter !== null) {
        if (typeof o.target_filter === 'string')
            targetFilter = o.target_filter;
    ...
    let conditionConfig = { require_active_obligation: true, obligation_types: [] };
    if (o.condition_config !== undefined) {
        ...
        conditionConfig = { ...o.condition_config };
    ...
    let scheduleConfig = { kind: 'manual', hint: '' };
    if (o.schedule_config !== undefined) {
        ...
        scheduleConfig = { ...o.schedule_config };
    }
    return {
...
export function normalizeLegalValuePayloadJsonInput(input) {
...
export function validateLegalValueVersionPayloadIfDocflow(valuePayloadJson) {
