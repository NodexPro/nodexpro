...
export function projectWorkItemToClientTasks(_workItemId) {
    throw new AppError(501, 'Work Engine projection to client_tasks is not implemented in Stage 2', 'WORK_ENGINE_PROJECTION_PENDING');
}
export function projectAllOrgWorkItemsToClientTasks(_orgId) {
    throw new AppError(501, 'Work Engine bulk projection to client_tasks is not implemented in Stage 2', 'WORK_ENGINE_PROJECTION_PENDING');
}
