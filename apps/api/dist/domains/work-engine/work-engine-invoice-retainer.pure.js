...
export const RECURRING_APPROVED_EVENT_TYPE = 'recurring_document_approved';
export const RECURRING_SEND_FOLLOWUP_EVENT_TYPE = 'recurring_document_send_followup_due';
export const RECURRING_SEND_FOLLOWUP_WORK_TYPE = 'recurring_document_send_followup';
