...
test('sectioned style renders section wrappers excel header and same columns', () => {
  ...
  assert.match(previewHtml, /\.nx-doc--sectioned \.nx-doc__upper-sheet[\s\S]*grid-template-areas:/);
  assert.match(previewHtml, /issuerIdentity documentIdentity/);
  assert.match(previewHtml, /issuerContacts customerContacts/);
  assert.match(previewHtml, /\.nx-doc--sectioned \.nx-doc__upper-sheet[\s\S]*grid-template-columns: minmax\(0, 1fr\) minmax\(0, 1fr\)/);
  assert.match(previewHtml, /\.nx-doc--sectioned \.nx-doc__upper-sheet[\s\S]*grid-template-rows: 65px auto auto auto/);
  assert.match(previewHtml, /\.nx-doc--sectioned \.nx-doc__sheet-section--1[\s\S]*grid-area: issuerIdentity/);
  assert.match(previewHtml, /\.nx-doc--sectioned \.nx-doc__sheet-section--1[\s\S]*height: 65px/);
  ...
  assert.match(previewHtml, /--nx-doc-logo-frame-width:\s*322px/);
  ...
  assert.match(previewHtml, /\.nx-doc--sectioned \.nx-doc__doc-identity[\s\S]*calc\(var\(--nx-doc-identity-stack-width\) \* 1\.22\)/);
  ...
  assert.match(previewHtml, /\.nx-doc--sectioned \.nx-doc__doc-number-bar[\s\S]*min-height: 28px/);
  assert.match(previewHtml, /\.nx-doc--sectioned \.nx-doc__doc-title[\s\S]*font-size: 30px/);
  assert.match(previewHtml, /\.nx-doc--sectioned \.nx-doc__doc-title[\s\S]*text-align: start/);
  assert.match(previewHtml, /\.nx-doc--sectioned \.nx-doc__sheet-section--3[\s\S]*padding: 0 10px/);
  assert.match(previewHtml, /\.nx-doc--sectioned \.nx-doc__sheet-section--3 \.nx-doc__sheet-section-body[\s\S]*align-items: flex-start/);
