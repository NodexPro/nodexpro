...
test('sectioned style matches golden-master printable layout', () => {
  ...
  assert.match(previewHtml, /\.nx-doc--sectioned \.nx-doc__upper[\s\S]*grid-template-columns: minmax\(0, 1fr\) minmax\(0, 1fr\)/);
  assert.match(previewHtml, /\.nx-doc--sectioned[\s\S]*padding: 24px/);
  ...
  assert.match(previewHtml, /\.nx-doc--sectioned \.nx-doc__doc-title[\s\S]*font-size: 28px/);
