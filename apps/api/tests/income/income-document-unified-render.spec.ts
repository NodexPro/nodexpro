...
test('sectioned style matches golden-master printable layout', () => {
  ...
  assert.match(
    previewHtml,
    /\.nx-doc--sectioned \.nx-doc__upper[\s\S]*grid-template-columns: 1fr 1fr/,
  );
  assert.match(
    previewHtml,
    /nx-doc__upper[\s\S]*nx-doc__doc-column[\s\S]*nx-doc__branding/,
  );
  assert.match(previewHtml, /\.nx-doc--sectioned[\s\S]*--nx-doc-branding-col:\s*378px/);
  assert.match(previewHtml, /\.nx-doc--sectioned[\s\S]*--nx-doc-doc-col:\s*378px/);
  assert.match(previewHtml, /\.nx-doc--sectioned[\s\S]*--nx-doc-logo-h:\s*60px/);
  assert.match(previewHtml, /\.nx-doc--sectioned[\s\S]*--nx-doc-logo-w:\s*255px/); /* medium: 0.85×300×70 */
  ...
  assert.match(previewHtml, /font-family: Arial, Helvetica, sans-serif !important/);
  ...
  assert.match(previewHtml, /\.nx-doc--sectioned \.nx-doc__customer-line-value[\s\S]*font-weight: 700/);
  ...
  assert.match(previewHtml, /\.nx-doc--sectioned \.nx-doc__issuer-lines[\s\S]*grid-row: 2/);
  assert.match(previewHtml, /\.nx-doc--sectioned \.nx-doc__meta-list[\s\S]*grid-row: 2/);
  assert.match(previewHtml, /\.nx-doc--sectioned \.nx-doc__meta-list[\s\S]*margin: 0 0 20px/);
  assert.match(previewHtml, /\.nx-doc--sectioned \.nx-doc__doc-column,\s*\.nx-doc--sectioned \.nx-doc__branding[\s\S]*display: contents/);
  assert.match(previewHtml, /nx-doc__branding-head/);
  assert.match(previewHtml, /\.nx-doc--sectioned \.nx-doc__meta-row[\s\S]*border-bottom: 1px solid #e8e8f2/);
  ...
  assert.match(previewHtml, /\.nx-doc--sectioned \.nx-doc__logo-frame[\s\S]*margin: 0 0/);
  ...
  assert.doesNotMatch(previewHtml, />סכום</);
  assert.doesNotMatch(previewHtml, /data-income-allocation-edit/);
